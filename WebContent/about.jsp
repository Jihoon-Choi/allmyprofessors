...
<body>
	...
	<!--교수랭킹-->
		...
		<div id="contentsWrap">
    <br/>
    <div id=subject_about>Allmyprofesoors.com</div><br/><br/>
    <div id="aligncontent">
    <ul>
    <li>
    <img src="img/about_img.png" alt="소개사진">
    <div id="aboutcontent">
      'All my professors' 사이트는 학생들의 강의평가를 통해 교수에 대한 평가를 순위로 보여줍니다.<br/>
      ...
      회원가입을 하면 더 많은 혜택을 누릴 수 있습니다 ! <br/><br/>
